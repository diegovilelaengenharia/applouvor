...
<div style="max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div class="step-box">
        ...
        <a href="../../database/data/Musicas_Louveapp_1768828036289.xlsx" download class="btn-outline ripple" style="width: 100%; justify-content: center; text-decoration: none;">
