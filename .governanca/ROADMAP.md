...
> Novo ciclo pela skill **`vilela-gsd`**. FASE 00 (infra) fechada 2026-07-15. **FASE 01
> (Arquitetura Core) fechada 2026-07-16** (`fases/FASE-01-PLANO.md`) — verde em produção.
> Fases futuras existem só como títulos até a anterior fechar. A **visão de produto abaixo
> continua válida** (decisões travadas 2026-06-05: superar o LouveApp em cifras/palco/
> inteligência, sem SaaS pago) — o que muda é o RITMO: infra primeiro, uma fase por vez,
> verificação por execução. Milestones v1.0–v5.0 abaixo = referência do ciclo v6 (a numeração
> de fases do v7 é independente, começa na FASE 00 de infra).
