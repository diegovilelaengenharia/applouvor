...
">
    <div style="max-width: 900px; margin: 0 auto;">
        <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 8px;">
            ...
            <h1 style="margin: 0; font-size: 1.75rem; font-weight: 700;">Escalas</h1>
        </div>
        <p style="margin: 0; opacity: 0.95; font-size: 0.95rem;">Gerencie as escalas de louvor da PIB Oliveira</p>
    </div>
</div>
