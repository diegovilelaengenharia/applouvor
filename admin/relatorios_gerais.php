    ...
    <body>
        ...
        <div class="grid-4">
            <?php 
                $kpis = [
                    ...
                    ['Capítulos', number_format($kpi_chapters), '#2E7EED']
                ];
                foreach($kpis as $k): ?>
        ...
        <div class="section" style="page-break-before: always;">
            ...
            <div class="alert-box" style="background: var(--rose-50); border: 1px solid var(--rose-100);">
                <h3 style="color: var(--rose-600); margin-top: 0;">?? Músicas Esquecidas (Não tocadas há 90+ dias)</h3>
                <div class="grid-2">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(350px, 1fr)); gap: 20px;">
            ...
            <div id="section-reading">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 16px; margin-bottom: 32px;">
                    ...
                    <div style="background: #EBF3FD; border: 1px solid #BED7F8; padding: 20px; border-radius: 12px; text-align: center;">
                         <div style="font-size: 0.8rem; color: #1A6FD6; font-weight: 600; text-transform: uppercase; margin-bottom: 8px;">Taxa de Adesão</div>
        ...
        <div class="content-card" style="grid-column: 1 / -1;">
            <div class="stat-title" onclick="toggleSection('absences')">
                <span>?? ANÁLISE DE AUSÊNCIAS</span>
