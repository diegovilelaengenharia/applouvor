...
">
    <div style="display: flex; justify-content: space-between; align-items: flex-start;">
        <div>
            <h1 style="color: white; margin: 0; font-size: 2rem; font-weight: 800; letter-spacing: -0.5px;">Indisponibilidades</h1>
...
<div class="container fade-in-up">
    <div style="text-align: center; padding: 40px 20px;">
        <div style="background: var(--bg-tertiary); width: 80px; height: 80px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 20px;">
            <i data-lucide="calendar-x" style="color: var(--text-muted); width: 40px; height: 40px;"></i>
        </div>
