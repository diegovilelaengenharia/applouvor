...
<div style="max-width: 800px; margin: 0 auto; padding-bottom: 60px;">
    ...
    <div class="settings-section">
        ...
        <div class="settings-card" style="text-align: center; padding: 24px;">
            ...
            <a href="https://wa.me/55359984529577" target="_blank" class="btn-outline ripple" style="margin-top: 20px;">
                <i data-lucide="message-circle" style="width: 16px;"></i> Suporte / Sugestões
            </a>
        </div>
    </div>
