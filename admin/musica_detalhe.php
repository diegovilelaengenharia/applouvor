...
';
    ...
    <div class="info-section">
        ...
        <!-- Spotify -->
        <div class="ref-link">
            <a href="<?= $song['link_spotify'] ?: '#' ?>" class="ripple" style="display: flex; align-items: center; gap: 12px; text-decoration: none; color: inherit; width: 100%;">
        ...
        <!-- YouTube -->
        <div class="ref-link">
            <a href="<?= $song['link_youtube'] ?: '#' ?>" class="ripple" style="display: flex; align-items: center; gap: 12px; text-decoration: none; color: inherit; width: 100%;">
        ...
        <!-- Apple Music -->
        <div class="ref-link">
            <a href="<?= $song['link_apple_music'] ?: '#' ?>" class="ripple" style="display: flex; align-items: center; gap: 12px; text-decoration: none; color: inherit; width: 100%;">
        ...
        <!-- Deezer -->
        <div class="ref-link">
            <a href="<?= $song['link_deezer'] ?: '#' ?>" class="ripple" style="display: flex; align-items: center; gap: 12px; text-decoration: none; color: inherit; width: 100%;">
