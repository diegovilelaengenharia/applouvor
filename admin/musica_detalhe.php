...
';
    ...
    <div class="info-section">
        ...
        <!-- Spotify -->
        <div class="ref-link">
            <a href="<?= ($song['link_spotify'] ?? null) ?: '#' ?>" class="ripple" style="display: flex; align-items: center; gap: 12px; text-decoration: none; color: inherit; width: 100%;">
                ...
                <div style="flex: 1;">
                    ...
                    <div style="font-size: 0.75rem; color: #94a3b8; text-decoration: none; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; max-width: 200px;"><?= ($song['link_spotify'] ?? null) ?: 'Não cadastrado' ?></div>
                </div>
                <i data-lucide="external-link" style="width: 16px; color: #cbd5e1;"></i>
            </a>
        </div>
        ...
        <!-- YouTube -->
        <div class="ref-link">
            <a href="<?= ($song['link_youtube'] ?? null) ?: '#' ?>" class="ripple" style="display: flex; align-items: center; gap: 12px; text-decoration: none; color: inherit; width: 100%;">
                ...
                <div style="flex: 1;">
                    ...
                    <div style="font-size: 0.75rem; color: #94a3b8; text-decoration: none; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; max-width: 200px;"><?= ($song['link_youtube'] ?? null) ?: 'Não cadastrado' ?></div>
                </div>
                <i data-lucide="external-link" style="width: 16px; color: #cbd5e1;"></i>
            </a>
        </div>
        ...
        <!-- Apple Music -->
        <div class="ref-link">
            <a href="<?= ($song['link_apple_music'] ?? null) ?: '#' ?>" class="ripple" style="display: flex; align-items: center; gap: 12px; text-decoration: none; color: inherit; width: 100%;">
                ...
                <div style="flex: 1;">
                    ...
                    <div style="font-size: 0.75rem; color: #94a3b8; text-decoration: none; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; max-width: 200px;"><?= ($song['link_apple_music'] ?? null) ?: 'Não cadastrado' ?></div>
                </div>
                <i data-lucide="external-link" style="width: 16px; color: #cbd5e1;"></i>
            </a>
        </div>
        ...
        <!-- Deezer -->
        <div class="ref-link">
            <a href="<?= ($song['link_deezer'] ?? null) ?: '#' ?>" class="ripple" style="display: flex; align-items: center; gap: 12px; text-decoration: none; color: inherit; width: 100%;">
                ...
                <div style="flex: 1;">
                    ...
                    <div style="font-size: 0.75rem; color: #94a3b8; text-decoration: none; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; max-width: 200px;"><?= ($song['link_deezer'] ?? null) ?: 'Não cadastrado' ?></div>
                </div>
                <i data-lucide="external-link" style="width: 16px; color: #cbd5e1;"></i>
            </a>
        </div>
