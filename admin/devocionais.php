...
renderHeroHeader('Devocionais', 'Louvor PIB Oliveira');
?>
...
<div class="container fade-in-up">
    ...
    <div style="text-align: center; padding: 60px 20px;">
        <div style="background: linear-gradient(135deg, #DBEAFE 0%, #BFDBFE 100%); width: 100px; height: 100px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 24px;">
            <i data-lucide="book-open" style="color: var(--primary-blue); width: 48px; height: 48px;"></i>
        </div>
        <h3 style="color: var(--text-primary); margin-bottom: 12px; font-size: 1.25rem; font-weight: 700;">Devocionais Diários</h3>
        ...
        <div style="display: grid; gap: 16px; max-width: 600px; margin: 0 auto; text-align: left;">
            ...
            <div style="background: var(--bg-secondary); border: 1px solid var(--border-subtle); border-radius: 16px; padding: 20px; box-shadow: var(--shadow-sm);">
                <div style="display: flex; gap: 16px; align-items: start;">
                    <div style="background: var(--info-light); padding: 12px; border-radius: 12px; text-align: center; min-width: 60px;">
                        <div style="font-size: 1.5rem; font-weight: 800; color: var(--info-dark);">20</div>
                        <div style="font-size: 0.75rem; color: var(--info-dark); font-weight: 600;">JAN</div>
                    </div>
                    <div style="flex: 1;">
                        <h4 style="margin: 0 0 4px; font-size: 1rem; font-weight: 600; color: var(--text-primary);">Título do Devocional</h4>
                        <p style="margin: 0 0 8px; font-size: 0.875rem; color: var(--text-secondary); line-height: 1.5;">
