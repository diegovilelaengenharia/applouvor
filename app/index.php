...
">
    ...
    <div style="display: flex; justify-content: space-between; align-items: flex-start;">
        <div>
            <h1 style="color: white; margin: 0; font-size: var(--font-size-2xl); font-weight: var(--font-weight-extrabold); letter-spacing: -0.5px;">Olá, <?= explode(' ', $_SESSION['user_name'])[0] ?>!</h1>
            <p style="color: rgba(255,255,255,0.9); margin-top: 4px; font-weight: var(--font-weight-medium); font-size: var(--font-size-base);">Área do Voluntário</p>
        </div>
    </div>
</div>
