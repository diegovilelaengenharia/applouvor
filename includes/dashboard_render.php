        ...
        <div class="card-info">
            <?php if ($nextSchedule): ?>
                ...
                <div class="card-footer-row">
                    ...
                    <span class="link-text">Ver Detalhes →</span>
                </div>
            <?php else: ?>
        ...
        <div class="card-info">
            <?php if ($ultimaMusica): ?>
                ...
                <div class="card-footer-row">
                    ...
                    <span class="link-text">Explorar →</span>
                </div>
            <?php else: ?>
...
function renderCardMembros($totalMembros, $stats) {
    ...
    <a href="membros.php" class="access-card card-blue">
        ...
        <div class="card-info">
            ...
            <span class="link-text float-right">Ver Equipe →</span>
        </div>
    </a>
    <?php
}
    ...
    <a href="leitura.php" class="access-card card-green">
        ...
        <div class="card-info">
            ...
            <div class="card-footer-row">
                ...
                <span class="link-text">Ler Agora →</span>
            </div>
        </div>
    </a>
    <?php
...
function renderCardAvisos($ultimoAviso, $unreadCount) {
    ...
    <a href="avisos.php" class="access-card card-violet">
        ...
        <?php if ($unreadCount > 0): ?>
            <span class="card-badge badge-pulse"><?= $unreadCount ?></span>
        <?php endif; ?>
        ...
        <div class="card-info">
            ...
            <div class="card-footer-row">
                ...
                <?php endif; ?>
                <span class="link-text">Ver Todos →</span>
            </div>
        </div>
    </a>
    <?php
        ...
        <div class="card-info">
            <?php if ($proximo): ?>
                ...
                <div class="card-footer-row">
                    ...
                    <span class="link-text">Ver Lista →</span>
                </div>
            <?php else: ?>
...
function renderCardDevocional() {
    ...
    <a href="devocionais.php" class="access-card card-green">
        ...
        <div class="card-info">
            ...
            <span class="link-text float-right">Ler Devocional →</span>
        </div>
    </a>
    <?php
}
    ...
    <a href="oracao.php" class="access-card card-green">
        ...
        <div class="card-info">
            <?php if ($count > 0): ?>
                ...
                <span class="link-text float-right">Ver Lista →</span>
            <?php else: ?>
                <div class="info-highlight">
                    <span class="highlight-subtitle">Nenhum pedido ativo</span>
                </div>
                <span class="link-text float-right">Fazer Pedido →</span>
            <?php endif; ?>
        </div>
    </a>
    <?php
...
function renderCardAgenda($nextEvent, $totalEvents) {
    ...
    ?>
    <a href="agenda.php" class="access-card card-blue">
        <div class="card-icon">
            <i data-lucide="calendar-days"></i>
        </div>
        <?php if ($totalEvents > 0): ?>
            <span class="card-badge"><?= $totalEvents ?></span>
        <?php endif; ?>
        ...
        <div class="card-info">
            <?php if ($nextEvent): ?>
                ...
                <div class="card-footer-row">
                    ...
                    <span class="link-text">Ver Agenda →</span>
                </div>
            <?php else: ?>
...
function renderCardHistorico($data) {
    ...
    ?>
    <a href="historico.php" class="access-card card-blue">
        <div class="card-icon">
